...
public class Order implements Serializable{
	...
	//查询出来的商品sku名字和数量
	private List<Map<String,Object>> skuNameAndNum;

	public List<Map<String, Object>> getSkuNameAndNum() {
		return skuNameAndNum;
	}

	public void setSkuNameAndNum(List<Map<String, Object>> skuNameAndNum) {
		this.skuNameAndNum = skuNameAndNum;
	}
