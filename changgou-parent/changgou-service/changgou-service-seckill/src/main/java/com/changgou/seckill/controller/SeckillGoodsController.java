...
public class SeckillGoodsController {
    ...
    public Result<List<SeckillGoods>> list(String time){
        ...
        return new Result<>(true,StatusCode.OK,"查询秒杀商品表列表成功",list);
    }
     ...
     */
    @RequestMapping("/one")
    public Result<SeckillGoods> one(String time,String id){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  SeckillGoods seckillGoods,@PathVariable String id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<SeckillGoods> findById(@PathVariable String id){
